...
def test_parse_sl_displayable_bar_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_bar.rpyc')))[1]
...
def test_parse_sl_displayable_vbar_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_vbar.rpyc')))[1]
...
def test_parse_sl_displayable_add_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_add.rpyc')))[1]
...
def test_parse_sl_displayable_null_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_null.rpyc')))[1]
...
def test_parse_sl_displayable_imagebutton_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_imagebutton.rpyc')))[1]
...
def test_parse_sl_displayable_textbutton_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_textbutton.rpyc')))[1]
...
def test_parse_sl_displayable_style_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_style.rpyc')))[1]
...
def test_parse_sl_displayable_style_in_frame_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_style_in_frame.rpyc')))[1]
...
def test_parse_sl_displayable_dismiss_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_dismiss.rpyc')))[1]
...
def test_parse_sl_displayable_on_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_on.rpyc')))[1]
...
def test_parse_sl_displayable_timer_statement():
    ...
    decompressed = pickle.loads(loader.load_file(os.path.join(os.path.dirname(__file__), 'test_sl_displayable_parser_for_timer.rpyc')))[1]
